...
def generate_excel_report(dataframe):
    ...
    for col in ws.columns:
        ...
        # 🟢 SECURE FIX APPLIED HERE: Grabbing column attribute safely via index reference anchor
...
st.caption("Type analytical questions about your plants (e.g., 'worst plant', 'total emissions', 'highest efficiency', or 'summary') inside
